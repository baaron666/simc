...
void elemental( player_t* p )
{
  ...
  default_->add_action( "use_item,slot=trinket1,if=!trinket.1.has_use_buff|!trinket.1.is.spymasters_web&(trinket.1.has_use_buff&(buff.fury_of_storms.up|!talent.fury_of_the_storms)&(cooldown.primordial_wave.remains>15|!talent.primordial_wave|spell_targets.chain_lightning>=2)|fight_remains<21|buff.ascendance.remains>12)", "normal trinkets" );
  default_->add_action( "use_item,slot=trinket1,if=trinket.1.is.spymasters_web&((fight_remains>180&buff.spymasters_report.stack>25|buff.spymasters_report.stack>35|fight_remains<80)&cooldown.ascendance.ready&(buff.fury_of_storms.up|!talent.fury_of_the_storms)&(cooldown.primordial_wave.remains>15|!talent.primordial_wave|spell_targets.chain_lightning>=2)|fight_remains<21)", "spymaster logic" );
  default_->add_action( "use_item,slot=trinket2,if=!trinket.2.has_use_buff|!trinket.2.is.spymasters_web&(trinket.2.has_use_buff&(buff.fury_of_storms.up|!talent.fury_of_the_storms)&(cooldown.primordial_wave.remains>15|!talent.primordial_wave|spell_targets.chain_lightning>=2)|fight_remains<21|buff.ascendance.remains>12)", "normal trinkets" );
  ...
  default_->add_action( "use_item,slot=main_hand,if=(buff.fury_of_storms.up|!talent.fury_of_the_storms|cooldown.stormkeeper.remains>10)&(cooldown.primordial_wave.remains>15|!talent.primordial_wave)|buff.ascendance.remains>12" );
  ...
  single_target->add_action( "ascendance,if=(talent.first_ascendant|fight_remains>200|fight_remains<90&prev_gcd.1.primordial_wave|buff.spymasters_web.up|!(trinket.1.is.spymasters_web|trinket.2.is.spymasters_web))&(buff.fury_of_storms.up|!talent.fury_of_the_storms)&(cooldown.primordial_wave.remains>15|!talent.primordial_wave)" );
