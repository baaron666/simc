...
void fury( player_t* p )
{
  ...
  action_priority_list_t* slayer_ra_st = p->get_action_priority_list( "slayer_ra_st" );
  action_priority_list_t* slayer_ra_mt  = p->get_action_priority_list( "slayer_ra_mt" );
  action_priority_list_t* slayer_am_st = p->get_action_priority_list( "slayer_am_st" );
  action_priority_list_t* slayer_am_mt = p->get_action_priority_list( "slayer_am_mt" );
  action_priority_list_t* thane_ra_st = p->get_action_priority_list( "thane_ra_st" );
  action_priority_list_t* thane_ra_mt = p->get_action_priority_list( "thane_ra_mt" );
  action_priority_list_t* thane_am_st   = p->get_action_priority_list( "thane_am_st" );
  action_priority_list_t* thane_am_mt   = p->get_action_priority_list( "thane_am_mt" );
  ...
  default_->add_action( "run_action_list,name=slayer_ra_st,if=talent.slayers_dominance&talent.reckless_abandon&active_enemies=1" );
  default_->add_action( "run_action_list,name=slayer_am_st,if=talent.slayers_dominance&talent.anger_management&active_enemies=1" );
  default_->add_action( "run_action_list,name=slayer_ra_mt,if=talent.slayers_dominance&talent.reckless_abandon&active_enemies>1" );
  default_->add_action( "run_action_list,name=slayer_am_mt,if=talent.slayers_dominance&talent.anger_management&active_enemies>1" );
  default_->add_action( "run_action_list,name=thane_ra_st,if=talent.lightning_strikes&talent.reckless_abandon&active_enemies=1" );
  default_->add_action( "run_action_list,name=thane_am_st,if=talent.lightning_strikes&talent.anger_management&active_enemies=1" );
  default_->add_action( "run_action_list,name=thane_ra_mt,if=talent.lightning_strikes&talent.reckless_abandon&active_enemies>1" );
  default_->add_action( "run_action_list,name=thane_am_mt,if=talent.lightning_strikes&talent.anger_management&active_enemies>1" );

  slayer_am_st->add_action( "recklessness,if=(!talent.anger_management&cooldown.avatar.remains<1&talent.titans_torment)|talent.anger_management|!talent.titans_torment" );
  slayer_am_st->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment" );
  slayer_am_st->add_action( "thunderous_roar,if=buff.enrage.up" );
  slayer_am_st->add_action( "champions_spear,if=(buff.enrage.up&talent.titans_torment&cooldown.avatar.remains<gcd)|(buff.enrage.up&!talent.titans_torment)" );
  slayer_am_st->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  slayer_am_st->add_action( "execute,if=debuff.marked_for_execution.stack=3|buff.ashen_juggernaut.remains<2|buff.sudden_death.stack=2&buff.sudden_death.remains<7|buff.sudden_death.remains<2" );
  slayer_am_st->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  slayer_am_st->add_action( "bladestorm,if=buff.enrage.up&(cooldown.recklessness.remains>=9|cooldown.avatar.remains>=9)" );
  slayer_am_st->add_action( "onslaught,if=talent.tenderize&buff.brutal_finish.up" );
  slayer_am_st->add_action( "rampage,if=!buff.enrage.up" );
  slayer_am_st->add_action( "raging_blow,if=buff.opportunist.up" );
  slayer_am_st->add_action( "bloodthirst,if=target.health.pct<35&talent.vicious_contempt&buff.bloodcraze.stack>=2" );
  slayer_am_st->add_action( "rampage,if=action.raging_blow.charges<=1&rage>=115" );
  slayer_am_st->add_action( "bloodthirst,if=buff.bloodcraze.stack>3|crit_pct_current>=85" );
  slayer_am_st->add_action( "raging_blow" );
  slayer_am_st->add_action( "bloodthirst" );
  slayer_am_st->add_action( "execute" );
  slayer_am_st->add_action( "rampage" );
  slayer_am_st->add_action( "onslaught,if=talent.tenderize" );
  slayer_am_st->add_action( "whirlwind,if=talent.meat_cleaver" );
  slayer_am_st->add_action( "slam" );
  slayer_am_st->add_action( "storm_bolt,if=buff.bladestorm.up" );

  slayer_ra_st->add_action( "recklessness,if=cooldown.avatar.remains<1&talent.titans_torment|!talent.titans_torment" );
  slayer_ra_st->add_action( "rampage,if=!buff.enrage.up" );
  slayer_ra_st->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment" );
  slayer_ra_st->add_action( "thunderous_roar,if=buff.enrage.up" );
  slayer_ra_st->add_action( "champions_spear,if=(buff.enrage.up&talent.titans_torment&cooldown.avatar.remains<gcd)|(buff.enrage.up&!talent.titans_torment)" );
  slayer_ra_st->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  slayer_ra_st->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  slayer_ra_st->add_action( "bladestorm,if=buff.enrage.up&cooldown.avatar.remains>=9" );
  slayer_ra_st->add_action( "execute,if=debuff.marked_for_execution.stack=3|buff.ashen_juggernaut.remains<2|buff.sudden_death.stack=2&buff.sudden_death.remains<7|buff.sudden_death.remains<2" );
  slayer_ra_st->add_action( "onslaught,if=talent.tenderize&buff.brutal_finish.up" );
  slayer_ra_st->add_action( "bloodbath,if=crit_pct_current>=85|buff.bloodcraze.stack>=3" );
  slayer_ra_st->add_action( "crushing_blow" );
  slayer_ra_st->add_action( "onslaught,if=talent.tenderize" );
  slayer_ra_st->add_action( "bloodbath,if=target.health.pct<35&talent.vicious_contempt" );
  slayer_ra_st->add_action( "rampage,if=rage>=115" );
  slayer_ra_st->add_action( "raging_blow" );
  slayer_ra_st->add_action( "bloodbath" );
  slayer_ra_st->add_action( "rampage" );
  slayer_ra_st->add_action( "bloodthirst" );
  slayer_ra_st->add_action( "execute" );
  slayer_ra_st->add_action( "onslaught" );
  slayer_ra_st->add_action( "whirlwind,if=talent.meat_cleaver" );
  slayer_ra_st->add_action( "slam" );
  slayer_ra_st->add_action( "storm_bolt,if=buff.bladestorm.up" );


  slayer_am_mt->add_action( "recklessness" );
  slayer_am_mt->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment" );
  slayer_am_mt->add_action( "thunderous_roar,if=buff.enrage.up" );
  slayer_am_mt->add_action( "champions_spear,if=(buff.enrage.up&talent.titans_torment&cooldown.avatar.remains<gcd)|(buff.enrage.up&!talent.titans_torment)" );
  slayer_am_mt->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  slayer_am_mt->add_action( "whirlwind,if=buff.meat_cleaver.stack=0&talent.meat_cleaver" );
  slayer_am_mt->add_action( "execute,if=talent.ashen_juggernaut&buff.ashen_juggernaut.remains<=gcd&buff.enrage.up" );
  slayer_am_mt->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  slayer_am_mt->add_action( "bladestorm,if=buff.enrage.up&cooldown.avatar.remains>=5" );
  slayer_am_mt->add_action( "onslaught,if=talent.tenderize" );
  slayer_am_mt->add_action( "execute,if=buff.enrage.up&debuff.marked_for_execution.stack=3" );
  slayer_am_mt->add_action( "rampage,if=!buff.enrage.up" );
  slayer_am_mt->add_action( "bloodthirst" );
  slayer_am_mt->add_action( "rampage,if=buff.slaughtering_strikes.stack>=2" );
  slayer_am_mt->add_action( "raging_blow" );
  slayer_am_mt->add_action( "execute,if=buff.enrage.up" );
  slayer_am_mt->add_action( "rampage" );
  slayer_am_mt->add_action( "onslaught" );
  slayer_am_mt->add_action( "whirlwind" );
  slayer_am_mt->add_action( "storm_bolt,if=buff.bladestorm.up" );


  slayer_ra_mt->add_action( "recklessness,if=(!talent.anger_management&cooldown.avatar.remains<1&talent.titans_torment)|!talent.titans_torment" );
  slayer_ra_mt->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment&buff.enrage.up" );
  slayer_ra_mt->add_action( "rampage,if=!buff.enrage.up&!talent.titans_torment" );
  slayer_ra_mt->add_action( "thunderous_roar,if=buff.enrage.up" );
  slayer_ra_mt->add_action( "champions_spear,if=(buff.enrage.up&talent.titans_torment&cooldown.avatar.remains<gcd)|(buff.enrage.up&!talent.titans_torment)" );
  slayer_ra_mt->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  slayer_ra_mt->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  slayer_ra_mt->add_action( "bladestorm,if=buff.enrage.up&cooldown.avatar.remains>=9&buff.enrage.remains>3" );
  slayer_ra_mt->add_action( "whirlwind,if=buff.meat_cleaver.stack=0&talent.meat_cleaver" );
  slayer_ra_mt->add_action( "execute,if=talent.ashen_juggernaut&buff.ashen_juggernaut.remains<=gcd&buff.enrage.up" );
  slayer_ra_mt->add_action( "onslaught,if=talent.tenderize&buff.brutal_finish.up" );
  slayer_ra_mt->add_action( "rampage,if=!buff.enrage.up" );
  slayer_ra_mt->add_action( "bloodbath,if=active_enemies>=6" );
  slayer_ra_mt->add_action( "crushing_blow" );
  slayer_ra_mt->add_action( "bloodbath" );
  slayer_ra_mt->add_action( "bloodthirst,if=active_enemies>=6" );
  slayer_ra_mt->add_action( "execute,if=buff.enrage.up&debuff.marked_for_execution.up" );
  slayer_ra_mt->add_action( "onslaught,if=talent.tenderize" );
  slayer_ra_mt->add_action( "rampage,if=rage>115" );
  slayer_ra_mt->add_action( "raging_blow,if=talent.slaughtering_strikes" );
  slayer_ra_mt->add_action( "onslaught" );
  slayer_ra_mt->add_action( "bloodthirst" );
  slayer_ra_mt->add_action( "raging_blow" );
  slayer_ra_mt->add_action( "whirlwind" );
  slayer_ra_mt->add_action( "storm_bolt,if=buff.bladestorm.up" );

  thane_am_st->add_action( "recklessness,if=talent.anger_management|!talent.titans_torment" );
  thane_am_st->add_action( "thunder_blast,if=buff.enrage.up" );
  thane_am_st->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment" );
  thane_am_st->add_action( "ravager" );
  thane_am_st->add_action( "thunderous_roar,if=buff.enrage.up" );
  thane_am_st->add_action( "champions_spear,if=buff.enrage.up&(cooldown.avatar.remains<gcd|!talent.titans_torment)" );
  thane_am_st->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  thane_am_st->add_action( "execute,if=talent.ashen_juggernaut&buff.ashen_juggernaut.remains<=gcd&buff.enrage.up" );
  thane_am_st->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  thane_am_st->add_action( "bladestorm,if=buff.enrage.up&talent.unhinged" );
  thane_am_st->add_action( "onslaught,if=talent.tenderize" );
  thane_am_st->add_action( "rampage" );
  thane_am_st->add_action( "bloodthirst,if=talent.vicious_contempt&target.health.pct<35&buff.bloodcraze.stack>=2|!dot.ravager.remains&buff.bloodcraze.stack>=3" );
  thane_am_st->add_action( "raging_blow" );
  thane_am_st->add_action( "execute,if=talent.ashen_juggernaut" );
  thane_am_st->add_action( "bloodthirst" );
  thane_am_st->add_action( "execute" );
  thane_am_st->add_action( "thunder_clap" );

  thane_ra_st->add_action( "recklessness,if=(!talent.anger_management&cooldown.avatar.remains<1&talent.titans_torment)|talent.anger_management|!talent.titans_torment" );
  thane_ra_st->add_action( "thunder_blast,if=buff.enrage.up" );
  thane_ra_st->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment&buff.enrage.up" );
  thane_ra_st->add_action( "ravager" );
  thane_ra_st->add_action( "thunderous_roar,if=buff.enrage.up" );
  thane_ra_st->add_action( "champions_spear,if=buff.enrage.up&(cooldown.avatar.remains<gcd|!talent.titans_torment)" );
  thane_ra_st->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  thane_ra_st->add_action( "execute,if=talent.ashen_juggernaut&buff.ashen_juggernaut.remains<=gcd&buff.enrage.up" );
  thane_ra_st->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  thane_ra_st->add_action( "bladestorm,if=buff.enrage.up&talent.unhinged" );
  thane_ra_st->add_action( "rampage,if=!buff.enrage.up" );
  thane_ra_st->add_action( "bloodbath,if=talent.vicious_contempt&target.health.pct<35|buff.bloodcraze.stack>=3" );
  thane_ra_st->add_action( "crushing_blow" );
  thane_ra_st->add_action( "onslaught,if=talent.tenderize" );
  thane_ra_st->add_action( "rampage,if=rage>=115" );
  thane_ra_st->add_action( "raging_blow" );
  thane_ra_st->add_action( "bloodbath" );
  thane_ra_st->add_action( "bloodthirst,if=buff.enrage.up&!buff.burst_of_power.up" );
  thane_ra_st->add_action( "rampage" );
  thane_ra_st->add_action( "execute" );
  thane_ra_st->add_action( "onslaught" );
  thane_ra_st->add_action( "bloodthirst" );
  thane_ra_st->add_action( "thunder_clap" );
  thane_ra_st->add_action( "whirlwind,if=talent.meat_cleaver" );
  thane_ra_st->add_action( "slam" );

  thane_am_mt->add_action( "recklessness,if=(!talent.anger_management&cooldown.avatar.remains<1&talent.titans_torment)|talent.anger_management|!talent.titans_torment" );
  thane_am_mt->add_action( "thunder_blast,if=buff.enrage.up" );
  thane_am_mt->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment" );
  thane_am_mt->add_action( "thunder_clap,if=buff.meat_cleaver.stack=0&talent.meat_cleaver" );
  thane_am_mt->add_action( "thunderous_roar,if=buff.enrage.up" );
  thane_am_mt->add_action( "ravager" );
  thane_am_mt->add_action( "champions_spear,if=buff.enrage.up" );
  thane_am_mt->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  thane_am_mt->add_action( "execute,if=talent.ashen_juggernaut&buff.ashen_juggernaut.remains<=gcd&buff.enrage.up" );
  thane_am_mt->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  thane_am_mt->add_action( "bladestorm,if=buff.enrage.up" );
  thane_am_mt->add_action( "onslaught,if=talent.tenderize" );
  thane_am_mt->add_action( "rampage" );
  thane_am_mt->add_action( "bloodthirst" );
  thane_am_mt->add_action( "thunder_clap,if=active_enemies>=3" );
  thane_am_mt->add_action( "raging_blow" );
  thane_am_mt->add_action( "thunder_clap" );
  thane_am_mt->add_action( "onslaught" );
  thane_am_mt->add_action( "execute" );
  thane_am_mt->add_action( "whirlwind" );
  thane_am_mt->add_action( "slam" );

  thane_ra_mt->add_action( "recklessness,if=cooldown.avatar.remains<1&talent.titans_torment|!talent.titans_torment" );
  thane_ra_mt->add_action( "thunder_blast,if=buff.enrage.up" );
  thane_ra_mt->add_action( "avatar,if=(talent.titans_torment&(buff.enrage.up|talent.titanic_rage)&(debuff.champions_might.up|!talent.champions_might))|!talent.titans_torment&buff.enrage.up" );
  thane_ra_mt->add_action( "thunder_clap,if=buff.meat_cleaver.stack=0&talent.meat_cleaver" );
  thane_ra_mt->add_action( "thunderous_roar,if=buff.enrage.up" );
  thane_ra_mt->add_action( "ravager" );
  thane_ra_mt->add_action( "champions_spear,if=buff.enrage.up" );
  thane_ra_mt->add_action( "odyns_fury,if=dot.odyns_fury_torment_mh.remains<1&(buff.enrage.up|talent.titanic_rage)&cooldown.avatar.remains" );
  thane_ra_mt->add_action( "execute,if=talent.ashen_juggernaut&buff.ashen_juggernaut.remains<=gcd&buff.enrage.up" );
  thane_ra_mt->add_action( "rampage,if=talent.bladestorm&cooldown.bladestorm.remains<=gcd&!debuff.champions_might.up" );
  thane_ra_mt->add_action( "bladestorm,if=buff.enrage.up" );
  thane_ra_mt->add_action( "onslaught,if=talent.tenderize" );
  thane_ra_mt->add_action( "rampage,if=!buff.enrage.up" );
  thane_ra_mt->add_action( "bloodbath" );
  thane_ra_mt->add_action( "crushing_blow" );
  thane_ra_mt->add_action( "rampage,if=buff.recklessness.up|rage>115" );
  thane_ra_mt->add_action( "onslaught,if=talent.tenderize" );
  thane_ra_mt->add_action( "bloodthirst" );
  thane_ra_mt->add_action( "thunder_clap" );
  thane_ra_mt->add_action( "raging_blow" );
  thane_ra_mt->add_action( "onslaught" );
  thane_ra_mt->add_action( "rampage" );
  thane_ra_mt->add_action( "execute" );
  thane_ra_mt->add_action( "whirlwind" );
  ...
  variables->add_action( "variable,name=on_gcd_racials,value=buff.recklessness.down&buff.avatar.down&rage<80&buff.crushing_blow.down&buff.sudden_death.down&!cooldown.bladestorm.ready&(!cooldown.execute.ready|!variable.execute_phase)" );
}
//fury_apl_end
...
void arms( player_t* p )
{
  ...
  colossus_execute->add_action( "mortal_strike,if=debuff.executioners_precision.stack=2&!dot.ravager.remains&(buff.lethal_blows.stack=2|!set_bonus.tww1_4pc&!talent.battlelord)|!talent.executioners_precision" );
  colossus_execute->add_action( "mortal_strike,if=talent.battlelord&debuff.executioners_precision.stack=2" );
  colossus_execute->add_action( "overpower,if=talent.battlelord&charges=2&rage<90" );
  ...
  colossus_sweep->add_action( "overpower,if=buff.sweeping_strikes.up" );
  colossus_sweep->add_action( "demolish,if=buff.sweeping_strikes.up&debuff.colossus_smash.up" );
  colossus_sweep->add_action( "execute,if=buff.sweeping_strikes.up" );
  ...
  colossus_aoe->add_action( "demolish,if=buff.colossal_might.stack>=6&talent.dreadnaught|buff.colossal_might.stack=10&talent.strength_of_arms" );
  ...
  slayer_execute->add_action( "overpower,if=buff.opportunist.up&rage<80&buff.martial_prowess.stack<2|rage<40&buff.martial_prowess.stack<2&talent.fierce_followthrough" );
  ...
  slayer_aoe->add_action( "overpower,if=talent.dreadnaught&buff.sweeping_strikes.up" );
  ...
  slayer_aoe->add_action( "overpower,if=talent.strength_of_arms&buff.sweeping_strikes.up" );
